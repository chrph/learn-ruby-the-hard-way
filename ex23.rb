...
# the require method in ruby is used to load another file and execute all its statements
# it imports all class and method definitions in the file
# load jekyll and execute its statements
require 'jekyll'

# load json and execute all its statements
require 'json'
require 'licensee'
require 'open-uri'

# modules are used to store methods and constants
# modules are used to share methods between classes
# declare a module called SpecHelper
module SpecHelper
  #declare a class inside the module
  #opens the singleton class object
  class << self
    #attr_accessor is a ruby method that creates reader and writer methods
...
def config
  #bring in existing module SpecHelper with config method
...
def licenses
  #bring in existing module SpecHelper with licenses method
